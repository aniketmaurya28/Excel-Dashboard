...
While using the pivot table create in the previous excel workbook a dashboard was created using following charts: 

Key Insights from charts and slicers - 

- Pie charts: For Category-wise and Region-wise Sales.
...
- Timeline: Showing the transition between years, quaters,, months and days for year 2016 to 2019.
